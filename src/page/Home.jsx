  ...
  return (
    <div className="d-flex flex-column min-vh-100 home-container">
      ...
      <div className="hero-banner position-relative" style={{ 
        height: '500px',
        background: 'linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.5)), url(https://images.unsplash.com/photo-1536440136628-849c177e76a1?q=80&w=1925&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)',
        ...
        <div className="container h-100 d-flex flex-column justify-content-center text-white">
          <div className="col-md-8 col-lg-6">
            ...
            <p className="lead my-4" style={{ textShadow: '1px 1px 3px rgba(0,0,0,0.5)' }}>
              Đặt vé ngay hôm nay để thưởng thức những bộ phim mới nhất trên màn ảnh rộng.
            </p>
            <div className="d-flex gap-3">
              ...
              <button className="btn btn-outline-light px-4 py-2" style={{ borderRadius: '8px' }}>
            ...
            <>
              <section className="mb-5">
                <div className="d-flex align-items-center justify-content-between mb-4">
                  ...
                  <a href="#" className="btn btn-sm" style={{ color: '#ff4b2b', borderColor: '#ff4b2b' }}>
